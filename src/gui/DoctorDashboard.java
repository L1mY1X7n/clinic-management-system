    ...
    private void initComponents() {
        ...
        jButton1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ViewRosterGUI(loggedInDoctor).setVisible(true);
            }
        });
        add(jButton1);
        ...
        jButton2.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new ViewAppointmentsGUI(loggedInDoctor).setVisible(true);
            }
        });
        add(jButton2);
        ...
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new MedicalRecordGUI(loggedInDoctor).setVisible(true);
            }
        });
        add(jButton3);
        ...
        jButton4.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                new PrescriptionGUI(loggedInDoctor).setVisible(true);
            }
        });
        add(jButton4);
