...
public class PatientDashboard extends javax.swing.JFrame {
    ...
    private final String medicalRecordsFile = "src/data/medical_records.txt";
    private final String prescriptionsFile = "src/data/prescriptions.txt";
    ...
    private void viewAppointments() {
        String[] columnNames = {"Appointment ID","Patient ID","Full Name","Date","Time","Reason","Status"};
    ...
    private void viewMedicalRecords() {
        ...
        File file = new File("src/data/medical_records.txt");
        if (!file.exists()) {
    ...
    private void initComponents() {
        ...
        btnPrescriptions.addActionListener(this::btnPrescriptionsActionPerformed);
